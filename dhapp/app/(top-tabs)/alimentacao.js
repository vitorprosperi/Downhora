        ...
        <SafeAreaView style={styles.container} edges={['bottom']}>
            <ScrollView contentContainerStyle={styles.scrollView}>
              <View style={styles.cardTitle}>
                ...
                <View style={styles.contTexto}>
                    <Text style={[styles.title, {textAlign: 'left'}]}>15 passos para uma alimentação saudável de crianças com síndrome de Down</Text>
                ...
                <View style={styles.contTexto}>
                    <Text style={[styles.title, {textAlign: 'left'}]}>15 passos para uma alimentação saudável de adolescentes com síndrome de Down</Text>
                ...
                <View style={styles.contTexto}>
                    <Text style={[styles.title, {textAlign: 'left'}]}>Classificação dos alimentos quanto ao grau de processamento</Text>
